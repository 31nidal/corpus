...
export const authoredCanonicalCourses = [...chemistryCourses, ...cellBiologyCourses, ...biochemistryCourses, ...geneticsCourses, ...embryologyCourses, ...histologyCourses, ...biophysicsCourses, ...physiologyCourses, ...immunologyCourses, ...statisticsCourses, ...pharmacologyCourses, ...publicHealthCourses, ...shsCourses, ...upperLimbCourses, ...lowerLimbCourses]
export const authoredCanonicalQuestions = [...chemistryQuestions, ...cellBiologyQuestions, ...biochemistryQuestions, ...geneticsQuestions, ...embryologyQuestions, ...histologyQuestions, ...biophysicsQuestions, ...physiologyQuestions, ...immunologyQuestions, ...statisticsQuestions, ...pharmacologyQuestions, ...publicHealthQuestions, ...shsQuestions, ...upperLimbQuestions, ...lowerLimbQuestions]
export const authoredCanonicalCourseIds = new Set(authoredCanonicalCourses.map(course => course.id))
export const authoredQuestionCourseIds = new Set([...curatedChemistryCourseIds, ...cellBiologyQuestionCourseIds, ...biochemistryQuestions.map(question => question.course), ...geneticsQuestions.map(question => question.course), ...embryologyQuestions.map(question => question.course), ...histologyQuestions.map(question => question.course), ...biophysicsQuestions.map(question => question.course), ...physiologyQuestions.map(question => question.course), ...immunologyQuestions.map(question => question.course), ...statisticsQuestions.map(question => question.course), ...pharmacologyQuestions.map(question => question.course), ...publicHealthQuestions.map(question => question.course), ...shsQuestions.map(question => question.course), ...upperLimbQuestions.map(question => question.course), ...lowerLimbQuestions.map(question => question.course)])
